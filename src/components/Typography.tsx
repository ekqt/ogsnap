  ...
  (props, ref) => {
    ...
    return (
      <h4
        id={id}
        className={cn(
          "mt-8 scroll-m-20 text-lg font-semibold tracking-tight lg:text-xl",
          className
        )}
        ref={ref}
        {...otherProps}
...
>((props, ref) => {
  ...
  return (
    <p
      className={cn("mt-2 text-xl leading-relaxed opacity-80", className)}
      ref={ref}
      {...otherProps}
    >
      {children}
